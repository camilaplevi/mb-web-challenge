...
<template>
  <div class="app">
    ...
    <StepThreeForm v-if="currentStep === 3" @next="nextStep" @back="prevStep" :userType="userType" :formData="formData" />
    <StepFourForm v-if="currentStep === 4" @next="nextStep" @back="prevStep" :userType="userType" :formData="formData" />
  </div>
</template>
